...
public class Pathfinding2D {
    ...
    public Pathfinding2D(Grid2D grid) {
        this.grid = grid;
    }
    ...
    public void FindPath(Vector3 startPos, Vector3 targetPos) {
        ...
        FindPath(seekerNode, targetNode);
    }
    public void FindPath(Node2D startPoint, Node2D targetPoint) {
        //get player and target position in grid coords
        seekerNode = startPoint;
        targetNode = targetPoint;
